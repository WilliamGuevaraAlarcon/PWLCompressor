...
public:
    ...
    PWLCompressor(DoubleVec Sample, const double Accuracy, const DoubleVec EnforcedInterpolationQuantiles, unsigned int AtomDetectionMinimumSampleSize, double RelativeAtomDetectionThreshold, const bool CheckFullAdmissibility);
    ~PWLCompressor(void);
...
private:
    ...
    void FullConstructor(DoubleVec Sample, const double Accuracy, const DoubleVec EnforcedInterpolationQuantiles, unsigned int AtomDetectionMinimumSampleSize, double RelativeAtomDetectionThreshold, const bool CheckFullAdmissibility);
};
